...
- `response-recall` — retained `investigationHistory`, `resolutionMemory`, and
  `incidentMemory` (always present; `[]` is known-empty). Exact prior records,
  not similar incidents or recommendations.
